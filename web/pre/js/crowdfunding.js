...
function listClick(value){
	...
	if(value == 1){
		...
		$("#crowdfunding_iframe").attr("src","/personal/my_info");
	...
	if(value == 2){
		...
		$("#crowdfunding_iframe").attr("src","/personal/make_head");
...
$("#listClick19").attr("class","");
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe").attr("src","/personal/identity_prove");
...
$("#listClick19").attr("class","");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","/personal/make_password");
...
$("#listClick19").attr("class","");
	...
	if(value == 5){
		...
		$("#crowdfunding_iframe").attr("src","/personal/apply_lingtou");
...
$("#listClick19").attr("class","");
	...
	if(value == 6){
		...
		$("#crowdfunding_iframe").attr("src","/personal/project_manage");
...
$("#listClick19").attr("class","");
	...
	if(value == 7){
		...
		$("#crowdfunding_iframe").attr("src","/personal/touhou_manage");
...
$("#listClick19").attr("class","");
	...
	if(value == 8){
		...
		$("#crowdfunding_iframe").attr("src","/personal/my_account");
...
$("#listClick19").attr("class","");
	...
	if(value == 9){
		...
		$("#crowdfunding_iframe").attr("src","/personal/investment_inquiry");
...
$("#listClick19").attr("class","");
	...
	if(value == 10){
		...
		$("#crowdfunding_iframe").attr("src","/personal/apply_refund");
...
$("#listClick19").attr("class","");
	...
	if(value == 11){
		...
		$("#crowdfunding_iframe").attr("src","/personal/grade_integration");
...
$("#listClick19").attr("class","");
	...
	if(value == 12){
		...
		$("#crowdfunding_iframe").attr("src","/personal/integration_record");
...
$("#listClick19").attr("class","");
	...
	if(value == 13){
		...
		$("#crowdfunding_iframe").attr("src","/personal/integration_rule");
...
$("#listClick19").attr("class","");
	...
	if(value == 14){
		...
		$("#crowdfunding_iframe").attr("src","/personal/messages");
...
$("#listClick19").attr("class","");
	...
	if(value == 15){
		...
		$("#crowdfunding_iframe").attr("src","/personal/inbox");
...
$("#listClick19").attr("class","");
	...
	if(value == 16){
		...
		$("#crowdfunding_iframe").attr("src","/personal/outbox");
	...
	if(value == 19){
		...
		$("#crowdfunding_iframe").attr("src","/personal/addnews");
